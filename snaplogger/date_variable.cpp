...
DEFINE_LOGGER_VARIABLE_IGNORED_ON_NO_REPEAT(date)
{
    tm t;
...
DEFINE_LOGGER_VARIABLE_IGNORED_ON_NO_REPEAT(time)
{
...
DEFINE_LOGGER_VARIABLE_IGNORED_ON_NO_REPEAT(locale)
{
    tm t;
    timespec const & timestamp(msg.get_timestamp());
